...
from qrope.stage81_soft_support_routed_token_selector_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
    ...
    print_stage81_summary,
    run_stage81_audit,
    write_stage81_outputs,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 81 soft support-routed token selector audit.")
    parser.add_argument("--seeds", type=_parse_int_list, default=DEFAULT_AUDIT_SEEDS)
    parser.add_argument("--examples-per-length", type=int, default=DEFAULT_SUPPORT_COMPLETE_EXAMPLES_PER_LENGTH)
    ...
    paths = write_stage81_outputs(result, args.output_dir)
    print_stage81_summary(result)
