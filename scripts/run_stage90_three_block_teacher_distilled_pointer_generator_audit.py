...
from qrope.stage90_three_block_teacher_distilled_pointer_generator_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 90 three-block teacher-distilled pointer-generator audit.")
    ...
    paths = write_stage90_outputs(result, args.output_dir)
    print_stage90_summary(result)
