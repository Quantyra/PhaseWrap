...
from qrope.stage186_target_control_semantics_audit import (  # noqa: E402
    DEFAULT_OUTPUT_DIR,
    DEFAULT_STAGE182_RESULTS,
    DEFAULT_STAGE183_RESULTS,
    DEFAULT_STAGE184_RESULTS,
    DEFAULT_STAGE185_RESULTS,
    print_stage186_summary,
    run_stage186_target_control_semantics_audit,
    write_stage186_outputs,
)


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Audit target/control semantics after exhausted redesign sweep.")
    ...
    parser.add_argument("--stage185-results", type=Path, default=DEFAULT_STAGE185_RESULTS)
    ...
    result = run_stage186_target_control_semantics_audit(
        ...
        stage185_results_path=args.stage185_results,
    )
    paths = write_stage186_outputs(result, args.output_dir)
    print_stage186_summary(result)
