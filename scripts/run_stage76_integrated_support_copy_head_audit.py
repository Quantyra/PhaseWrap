...
from qrope.stage76_integrated_support_copy_head_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
    DEFAULT_EXAMPLES_PER_LENGTH,
    DEFAULT_LEARNING_RATE,
    DEFAULT_OUTPUT_DIR,
    print_stage76_summary,
    run_stage76_audit,
    write_stage76_outputs,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 76 integrated support/copy-head audit.")
    ...
    paths = write_stage76_outputs(result, args.output_dir)
    print_stage76_summary(result)
