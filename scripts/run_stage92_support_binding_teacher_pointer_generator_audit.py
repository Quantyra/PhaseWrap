...
from qrope.stage92_support_binding_teacher_pointer_generator_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 92 support-binding teacher pointer-generator audit.")
    ...
    parser.add_argument("--support-binding-weight", type=float, default=DEFAULT_SUPPORT_BINDING_WEIGHT)
    ...
    result = run_stage92_audit(
        ...
        support_binding_weight=args.support_binding_weight,
    )
    paths = write_stage92_outputs(result, args.output_dir)
    print_stage92_summary(result)
