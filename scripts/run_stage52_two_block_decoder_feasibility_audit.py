...
from qrope.stage52_two_block_decoder_feasibility_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 52 two-block decoder feasibility audit.")
    ...
    paths = write_stage52_outputs(result, args.output_dir)
