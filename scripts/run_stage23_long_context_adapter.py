...
from qrope.stage23_long_context_adapter import (  # noqa: E402
    DEFAULT_CONTEXT_LENGTHS,
    DEFAULT_EXAMPLES_PER_TASK_LENGTH,
    DEFAULT_OUTPUT_DIR,
    DEFAULT_SEEDS,
    print_stage23_table,
    run_stage23_benchmark,
    write_stage23_outputs,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run deterministic Stage 23 long-context positional adapter benchmark.")
    ...
    paths = write_stage23_outputs(result, args.output_dir)
    print_stage23_table(result)
