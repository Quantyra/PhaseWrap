...
from qrope.stage19_value_output_hardening import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run deterministic Stage 19 value-output hardening probe.")
    ...
    paths = write_stage19_outputs(result, args.output_dir)
    print_stage19_table(result)
