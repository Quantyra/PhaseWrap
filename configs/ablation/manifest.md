...
## Purpose
Single reference for the first PhaseWrap ablation batch config files.
...
- `V3`: PhaseWrap relative-phase encoding
- `V4`: damped-and-clipped PhaseWrap relative-phase encoding
- `V4b`: clipped ratio-controlled PhaseWrap relative-phase encoding
