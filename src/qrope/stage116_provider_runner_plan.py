...
def _provider_command(provider: str, shard_path: str, result_path: str) -> str:
...
def _runner_record(shard_path: str, stage114_manifest: dict[str, Any], provider_records: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "runner_command": _provider_command(provider, str(shard.as_posix()), result_path),
...
def run_stage116_runner_plan(
    *,
    ...
    sources = [(stage111_results_path, stage111), (stage114_manifest_path, stage114)]
    ...
    runner_records = [
        _runner_record(str(path), stage114, provider_records)
    ...
    return {
        ...
        "next_gate": (
            "Clear Stage 111 provider readiness, then execute only the declared runner commands and collect their result "
            "files through Stage 115."
        ),
    }
