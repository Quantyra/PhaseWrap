# Q-RoPE Transition Orbit Slot-Invariant Top-K Pair-Order Signed Flip Reversion Implementation v1

Date: 2026-03-11
Stories: S631

## Scope
- implemented the bounded `synthetic_transition_orbit_slot_invariant_topk_pair_order_signed_flip_reversion_binary` branch only
- local-only
- zero-credit
- fixed three-seed packet

## Changes
- added the reversion dataset wrapper in `src/qrope/synthetic.py`
