# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Residual Family v1

Date: 2026-03-11
Stories: S752

## Purpose
Define one materially stronger symbolic family beyond the dual-atlas bilinear residual control while preserving auditability and preventing hidden lookup behavior.
...
- stronger extension:
  - one bounded directional transition-residual family over the same frozen 4x4 lattice
  - each lattice cell may gate exactly two transition-residual channels:
...
- for each lattice cell, exactly these transition-residual features:
  - `cell_ij_kl_source_to_dest_orientation_minus_content`
  - `cell_ij_kl_dest_to_source_orientation_minus_content`
...
- any directional transition feature beyond the two frozen definitions

## Rationale
- the dual-atlas bilinear residual family stayed materially weaker than the witness
- the next fairer symbolic challenge is not a larger lattice or more charts
- it is one narrowly bounded directional transition-residual layer over the same frozen lattice
- this is materially stronger than plain bilinear residual gating while still auditable and mechanically frozen
