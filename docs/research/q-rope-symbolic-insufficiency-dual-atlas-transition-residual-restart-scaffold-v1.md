# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Residual Restart Scaffold v1
...
- allowed base cell interactions:
  ...
  - `orientation_delta`
- allowed residual-gating interactions:
  - `orientation_minus_content`
  - `orientation_plus_content`
- allowed bilinear residual interactions:
  - `sector_times_orientation_minus_content`
  - `sector_times_orientation_plus_content`
- allowed directional transition-residual interactions only:
