# Q-RoPE Transition Orbit Slot-Invariant Top-K Pair-Order Signed Flip Consistency Restart Scaffold v1
...
- do not approve implementation until the task proves:
  ...
  - `coarse_slot_topk_pair_signed_flip_lookup_near_null_pass = true`
  - `within_state_topk_pair_signed_flip_variation_pass = true`
  - `paired_context_diversity_pass = true`
  - `signed_flip_label_balance_pass = true`

## Explicitly Disallowed
- reopening the failed signed-consistency task
- remote execution
- benchmark expansion
