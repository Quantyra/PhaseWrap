# Q-RoPE Transition Orbit Listwise Deeper Pair-Reindex Hardening Plan v1
...
- if it loses the primary listwise metric after this deeper pairing perturbation, stop the execution branch
