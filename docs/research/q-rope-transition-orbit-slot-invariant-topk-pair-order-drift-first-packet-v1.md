# Q-RoPE Transition Orbit Slot-Invariant Top-K Pair-Order Drift First Packet v1
...
- seeds: `42`, `123`, `777`
- candidate: `V_future_relational_witness_transition_orbit_topk_pair_order_drift_invariant`
- controls:
