# Q-RoPE Transfer Counterfactual-Handoff Implementation v1
...
- Control: `V_control_symbolic_symbolic_insufficiency_counterfactual_handoff_regressor`
- Backend: `sim_quantum_statevector`
- Seeds: `42`, `123`, `777`

## Implementation
- Added the counterfactual-handoff synthetic generator to `src/qrope/synthetic.py`.
