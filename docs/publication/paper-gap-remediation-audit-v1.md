...
| External review flagged provisional-number/date credibility. | `docs/publication/patent-status-note-v1.md`, `PATENTS.md`, `README.md`, and paper now use basic patent-pending wording and application number. | Addressed. |
