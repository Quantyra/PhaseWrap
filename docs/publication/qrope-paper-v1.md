...
- Stage 6, Stage 7, Stage 8, Stage 9, Stage 10, Stage 12, Stage 13, Stage 14, Stage 15, Stage 16, Stage 17, Stage 18, Stage 19, Stage 20, Stage 21, Stage 22, and Stage 23 are toy downstream, retrieval, compact trained positional-attention, positional-adapter, attention-readout, learned attention-readout, stability, value-output capacity/hardening, or very small transformer experiments, not production transformer evaluations.
...
| 2 | Stronger standard retrieval tasks | Stage 23 now trains adapters on the long-context explicit retrieval packet and shows PhaseWrap-plus-distance can recover top-1/MRR through 4096, with a remaining RoPE probability-mass advantage. Next, move to trained small-transformer Needle-in-Haystack, RULER-style multi-hop/aggregation, or compact natural-language QA tasks with matched compute and multiple seeds. |
| 3 | Comparable PhaseWrap mechanism | Stage 13 through Stage 23 now test adapters around PhaseWrap features and show that explicit distance terms are needed on exact-offset retrieval and value readout. Stage 23 supports the adapter direction while preserving the calibration gap versus RoPE-like scoring. |
