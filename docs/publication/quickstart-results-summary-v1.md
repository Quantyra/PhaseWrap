...
| Next downstream gate | Stronger decoder-only transformer | Scale or redesign the Stage 52 stronger decoder enough to generalize on retrieval tasks, then rerun the same fair comparison. |
