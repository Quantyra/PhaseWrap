...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 76 enough to preserve visible-cue recovery in a matched decoder-only mechanism before testing positional-method promotion. |
