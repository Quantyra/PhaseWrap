...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond the Stage 54 auxiliary-loss two-block path enough to generalize on retrieval tasks, then rerun the same fair comparison. |
