...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 57 enough to learn the support-aware phase-cued rule from standard inputs, then rerun the same fair comparison. |
