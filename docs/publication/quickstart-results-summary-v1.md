...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 64 enough to improve held-out retrieval generalization before testing positional-method promotion. |
