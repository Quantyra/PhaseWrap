...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 58 enough to internalize the support-aware phase-cued rule in a matched decoder, then rerun the same fair comparison. |
