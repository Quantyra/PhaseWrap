...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 71 enough to improve original phase-cued/exact-offset retrieval generalization before testing positional-method promotion. |
