...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 74 enough to learn visible-cue recovery in a matched decoder-only mechanism before testing positional-method promotion. |
