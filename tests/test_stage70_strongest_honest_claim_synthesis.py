...
def test_stage70_synthesis_bounds_claim_with_retrieval_failures(tmp_path) -> None:
    ...
    _write_manifest(
        ...
        "stage85_dual_auxiliary_pointer_generator_audit",
        {
            ...
            "decision": {
                ...
                "capacity_established": True,
                "retrieval_best_top1": {"phase_cued_retrieval": 0.05, "exact_offset_passkey": 0.416667},
                "retrieval_best_methods": {"phase_cued_retrieval": "sinusoidal", "exact_offset_passkey": "sinusoidal"},
    ...
    _write_manifest(
        ...
        "stage87_in_decoder_support_routed_copy_expert_audit",
        {
            ...
            "decision": {
                ...
                "capacity_established": True,
                "retrieval_best_top1": {"phase_cued_retrieval": 0.783333, "exact_offset_passkey": 0.416667},
                "retrieval_best_methods": {"phase_cued_retrieval": "rope_relative", "exact_offset_passkey": "sinusoidal"},
    ...
    _write_manifest(
        ...
        "stage90_three_block_teacher_distilled_pointer_generator_audit",
        {
            ...
            "decision": {
                ...
                "capacity_established": True,
                "retrieval_best_top1": {"phase_cued_retrieval": 0.033333, "exact_offset_passkey": 0.433333},
                "retrieval_best_methods": {"phase_cued_retrieval": "sinusoidal", "exact_offset_passkey": "sinusoidal"},
                "tiny_text_best_top1": 0.866667,
                "tiny_text_best_method": "sinusoidal",
            },
    ...
    _write_manifest(
        ...
        "stage91_curriculum_teacher_distilled_pointer_generator_audit",
        {
            ...
            "decision": {
                ...
                "capacity_established": True,
                "retrieval_best_top1": {"phase_cued_retrieval": 0.033333, "exact_offset_passkey": 0.333333},
                "retrieval_best_methods": {"phase_cued_retrieval": "sinusoidal", "exact_offset_passkey": "sinusoidal"},
                "tiny_text_best_top1": 0.95,
                "tiny_text_best_method": "sinusoidal",
            },
        },
    )
    ...
    _write_manifest(
        ...
        "stage96_claim_card_audit",
        {
            ...
            "decision": {
                ...
                "promotion_gate_ready": False,
                "claim_boundary": "The current strongest honest claim is bounded and reportable with intervals, but promotion remains unsupported.",
                "promotion_failed_requirements": ["free_learned_phasewrap_original_retrieval_solve"],
            },
        },
    )
    ...
    assert any(item.get("stage") == "stage96_claim_card_audit" for item in result["failure_modes"])
    ...
    assert any(item.get("source") == "stage96_claim_card_audit" for item in result["positive_evidence"])
    assert any(item.get("source") == "stage87_in_decoder_support_routed_copy_expert_audit" for item in result["positive_evidence"])
    assert result["source_stage"] == "stage96_claim_card_audit"
