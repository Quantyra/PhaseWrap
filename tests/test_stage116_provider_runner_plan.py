...
def test_stage116_reports_missing_sources(tmp_path) -> None:
    result = run_stage116_runner_plan(stage111_results_path=tmp_path / "missing111.json", stage114_manifest_path=tmp_path / "missing114.json")
...
def test_stage116_blocks_runner_when_stage111_provider_not_ready(tmp_path) -> None:
    ...
    result = run_stage116_runner_plan(stage111_results_path=tmp_path / "stage111.json", stage114_manifest_path=tmp_path / "stage114.json")
